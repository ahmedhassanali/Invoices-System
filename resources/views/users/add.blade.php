...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">@lang('site.users')</h4><span
                class="text-muted mt-1 tx-13 mr-2 mb-0">/@lang('site.add_user')</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="user_name">
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="email">
                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="password">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="confirm-password">
                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-md-12">
                            <div class="form-group">
                                <label class="form-label">@lang('site.user_role')</label>
