                            ...
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a
                                            href=" {{ url('invoicesDetails') }}/{{ $invoice->id }} ">{{ $invoice->categories->section_name }}</a>
                                    ...
                                    <td class="">
                                        ...
                                        <a class=" btn btn-sm btn-danger" data-effect="effect-scale" data-toggle="modal"
                                            data-invoice_id="{{ $invoice->id }}" href="#modal_delete" title="حذف"><i
                    ...
                    <form action="invoices/destroy" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-danger" data-dismiss="modal"
                                type="button">@lang('site.cancel')</button>
                        </div>
                    </form>
                </div>
            </div>
